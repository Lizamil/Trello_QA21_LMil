...
public class TestBase {
    ...
    public int getPersonalBoardsCount() {
        new WebDriverWait(driver,10).until(
                ExpectedConditions.presenceOfElementLocated(By.xpath("//span[@class='icon-lg icon-member']/../../..//li")));
    ...
    public void selectCloseBoardInMoreInMenuOnBoardPage() {
        new WebDriverWait(driver, 5).until(ExpectedConditions.
                presenceOfElementLocated(By.cssSelector(".js-close-board")));
    ...
    public int getTeamsCount() {
        new WebDriverWait(driver, 10).until(ExpectedConditions.
                presenceOfElementLocated(By.xpath("//div[@class='_mtkwfAlvk6O3f']/../../..//li")));
        //проверка что элемент просто присутствует на странице
    ...
    public void closeClosedBoardsForm() {
        new WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[class='_2BQG4yPMt5s_hu lAz6zCcJVJePNN _20uPs4MFhz7Z5r _3TXPFC9AbvtH0v iV27mPo7If_zwQ vmfY4Z5HOr-J1T']")));
    ...
    public int getClosedBoardsCount() {
       if (!isElementPresent(By.xpath("//ul[@class='_3Qi2qlYDnzYhMI']/li")))
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.presenceOfElementLocated(
                By.xpath("//ul[@class='_3Qi2qlYDnzYhMI']/li")));
        return driver.findElements(
