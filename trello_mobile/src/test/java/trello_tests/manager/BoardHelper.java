...
public class BoardHelper extends HelperBase {
    ...
    public int getPersonalBoardsCount() {
        waitPresenceElement(By.className("android.view.ViewGroup"), 15);
        return driver.findElements(By.className("android.view.ViewGroup")).size();
    ...
    public void fillBoardCreationForm(BoardData boardData) {
        type(By.id("board_name"), boardData.getBoardTitle());
//        click(By.id("team"));
//        click(By.xpath("//*[@text='Personal Boards (no team)']"));
    ...
    public void createBoard(BoardData board) {
        //  int countOfTeam = getTeamsCount();
        fillBoardCreationForm(board);
        waitPresenceElement(By.id("button1"), 20);
        click(By.id("button1"));
